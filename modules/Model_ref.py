...
class Seq2Seq(nn.Module):
    def __init__(self, encoder, decoder, lr, pad_id, n_ref, device):
        super().__init__()
    ...
    def batch_step(self, batch):
        ...
        Y_hat = self((X_enc, dec_in, enc_valid_lens))
        Y_hat, dec_tgt = Y_hat[:, self.n_ref:, :], dec_tgt[:, self.n_ref:]
        
        return self.loss(Y_hat, dec_tgt)
